          ...
          <div className="about-sheltek-area pt-90 pb-50">
            <div className="container">
              ...
              <div className="col-md-12 privacy-content pt-30">
                ...
                <p>
                  2. <b>Commercial Use of Service.</b> If you are using the Service and/or accessing the Websites on behalf of a company, entity, or organization (collectively, a “Subscribing Entity”), you represent and warrant that:
                </p>
                <p>
                ...
                <p>
                  Illegal and/or unauthorized uses of the Websites include, but are not limited to, browsing or downloading illegal content, collecting usernames and/or email addresses of members by electronic or other means for the purpose of sending unsolicited email, unauthorized framing of or linking to the Websites, sharing or disclosing your username or password to any third party or permitting any third party to access your account, attempting to impersonate another user or person, use of the Websites in any fraudulent or misleading manner, any automated use of the system, such as scraping the Websites, automated scripts, spiders, robots, crawlers, data mining tools or the like, interfering with, disrupting, or creating an undue burden on the Websites or the networks or services connected to the Websites, and using the Websites in a manner inconsistent with any and all applicable laws and regulations. Illegal and/or unauthorized use of the Websites may be investigated, and appropriate legal action may be taken, including without limitation, civil, criminal, and injunctive redress. Use of the Websites and Service is with the permission of Blackline Lending, which may be revoked at any time, for any reason, in Blackline Lending’s sole discretion.
                </p>

                <p>
                  3. <b>Account Security.</b> You are responsible for maintaining the confidentiality of the username and password that you designate during the registration process, and you are fully responsible for all activities that occur under your username and password. You agree to (a) immediately notify Blackline Lending of any unauthorized use of your username or password or any other breach of security, and (b) ensure that you exit from your account at the end of each session. Blackline Lending will not be liable for any loss or damage arising from your failure to comply with this provision. You should use particular caution when accessing your account from a public or shared computer so that others are not able to view or record your password or other personal information. If you share your computer with others, you may wish to consider disabling your auto-login feature if you have it linked to your Blackline Lending account.
                </p>

                <p>
                  4. <b>Your Use of the Websites</b>
                </p>
                <p>
                  a. You may not browse or download illegal content.
                </p>
                <p>
                  b. You must not copy or capture, or attempt to copy or capture, any content from the Websites (the “Content”) or any part of the Websites, unless given express permission by Blackline Lending.
                </p>
                <p>
                ...
                <p>
                  <ul>
                    <li>
                      any Content that is offensive, abusive, libelous, defamatory, obscene, racist, sexually explicit, ethnically or culturally offensive, indecent, that promotes violence, terrorism, or illegal acts, incites hatred on grounds of race, gender, religion or sexual orientation, or is otherwise objectionable in Blackline Lending’s sole and reasonable discretion;
                    </li>
                    <li>
                    ...
                    <li>
                      any Content that violates, breaches or is contrary to any law, rule, regulation, court order or is otherwise is illegal or unlawful in Blackline Lending’s sole and reasonable opinion;
                    </li>
                    <li>
                ...
                <p>
                  m. You must not stalk, exploit, threaten, abuse or otherwise harass another user, or any Blackline Lending employee. If we feel that your behavior towards any of our employees is at any time threatening or offensive, we reserve the right to immediately terminate your membership and you will not be entitled to any refund of unused subscription fees.
                </p>
                <p>
                  n. You must not sell or transfer, or offer to sell or transfer, any Blackline Lending account to any third party without the prior written approval of Blackline Lending.
                </p>
                <p>
                ...
                <p>
                  p. You must not violate, circumvent or attempt to violate or circumvent any data security measures employed by Blackline Lending or any Uploader; access or attempt to access data or materials which are not intended for your use; log into, or attempt to log into, a server or account which you are not authorized to access; attempt to scan or test the vulnerability of Blackline Lending’s servers, system or network or attempt to breach Blackline Lending’s data security or authentication procedures; attempt to interfere with the Websites or the Services by any means including, without limitation, hacking Blackline Lending’s servers or systems, submitting a virus, overloading, mail-bombing or crashing. Without limitation to any other rights or remedies of Blackline Lending under these Terms of Service, Blackline Lending reserves the right to investigate any situation that appears to involve any of the above, and may report such matters to, and cooperate with, appropriate law enforcement authorities in prosecuting any users who have participated in any such violations.
                </p>
                <p>
                  You agree to comply with the above conditions, and acknowledge and agree that Blackline Lending has the right, in its sole discretion, to terminate your account or take such other action as we see fit if you breach any of the above conditions or any of the other terms of these Terms of Service. This may include taking court action and/or reporting offending users to the relevant authorities.
                </p>

                <p>
                  5. <b>Representations and Warranties</b>. You hereby represent and warrant to Blackline Lending as follows:
                </p>
                <p>
                  a. Your Content, and each and every part thereof, is an original work by you, or you have obtained all rights, licenses, consents and permissions necessary in order to use, and (if and where relevant) to authorize Blackline Lending to use, Your Content pursuant to these Terms of Service, including, without limitation, the right to upload, reproduce, store, transmit, distribute, share, publicly display, publicly perform, make available and otherwise communicate to the public Your Content, and each and every part thereof, on, through or via the Websites, any and all Services and any third party services.
                </p>
                <p>
                ...
                <p>
                  e. Your Content does not and will not create any liability on the part of Blackline Lending, its subsidiaries, affiliates, successors, and assigns, and their respective employees, agents, directors, officers and/or shareholders.
                </p>
                <p>
                  Blackline Lending reserves the right to remove Your Content, suspend or terminate your access to the Platform and/or pursue all legal remedies if we believe that any of Your Content breaches any of the foregoing representations or warranties, or otherwise infringes another person's rights or violates any law, rule or regulation.
                </p>

                <p>
                  6. <b>Term.</b> This Agreement will remain in full force and effect while you use the Websites and/or Service. You may terminate your membership and/or subscription at any time by contacting us at <a href="mailto:info@blacklinelending.com">info@blacklinelending.com</a>. If you resign or cancel your membership and/or subscription to Blackline Lending, to help Blackline Lending analyze and improve the Service, you may be asked to provide a reason for your resignation/cancellation. Blackline Lending may terminate your membership and/or subscription for any reason by sending notice to you at the email address you provide in your application for membership, or such other email address as you may later provide to Blackline Lending. If Blackline Lending terminates your membership in the Service because you have breached this Agreement, you will not be entitled to any refund of unused subscription fees. All decisions regarding the termination of accounts shall be made in the sole discretion of Blackline Lending. Blackline Lending is not required to provide you notice prior to terminating your membership and/or subscription. Blackline Lending is not required, and may be prohibited, from disclosing a reason for the termination of your account. Even after your membership or subscription is terminated, this Agreement will remain in effect. All terms that by their nature may survive termination of this Agreement shall be deemed to survive such termination.
                </p>

                <p>
                  7. <b>Modifications to Service.</b> Blackline Lending reserves the right at any time to modify or discontinue, temporarily or permanently, the Service (or any part thereof) with or without notice. You agree that Blackline Lending shall not be liable to you or to any third party for any modification, suspension or discontinuance of the Service.
                </p>

                <p>
                  8. <b>Blocking of IP Addresses.</b> In order to protect the integrity of the Services, Blackline Lending reserves the right at any time in its sole discretion to block Members from certain IP addresses from accessing the Websites.
                </p>
                ...
                <p>
                  a. Proprietary Rights. Blackline Lending retains all proprietary rights in the Websites and the Service. The Websites contains the copyrighted material, trademarks, and other proprietary information of Blackline Lending, and its licensors. Except where we have given you express written permission, you may not copy, modify, publish, transmit, distribute, perform, display, or sell any such proprietary information. All content on Blackline Lending is proprietary. Except where otherwise specified in this Agreement, all Content is copyrighted material of Blackline Lending and for Blackline Lending’s Members' use only. Distribution of Content to others is strictly prohibited. You agree that Blackline Lending would be irreparably harmed by any violation or threatened violation of this section and that, therefore, Blackline Lending shall be entitled to an injunction prohibiting you from any violation or threatened violation of this section, without posting bond, in addition to any other right or remedy it may have.
                </p>
                <p>
                ...
                <p>
                  10. <b>Restrictions on Use of Materials.</b> You acknowledge that Blackline Lending contains images, text, and other content (collectively, "Intellectual Property") that is protected by copyrights, patents, trademarks, trade secrets and/or other proprietary rights, and that these rights are valid and protected in all forms, media and technologies existing now or hereafter developed. All Intellectual Property is copyrighted under the United States copyright laws (and, if applicable, similar foreign laws), and Blackline Lending owns a copyright in the selection, coordination, arrangement and enhancement of such Intellectual Property. All trademarks appearing on this Websites are trademarks of their respective owners. You may not modify, publish, transmit, distribute, perform, participate in the transfer or sale, create derivative works of, or in any way exploit, any of the Intellectual Property, in whole or in part. When Intellectual Property is downloaded to your computer, you do not obtain any ownership interest in such Intellectual Property. Modification of the Intellectual Property or use of the Intellectual Property for any other purpose, including, but not limited to, use of any Intellectual Property in printed form or on any other website or networked computer environment is strictly prohibited unless you receive our prior written consent.
                </p>

                <p>
                  11. <b>Copyright Policy.</b> Blackline Lending prohibits the submission or posting of any information that infringes or violates the copyright rights and/or other intellectual property rights (including rights of privacy and publicity) of any person or entity.
                </p>
                <p>
                  Pursuant to Title 17, United States Code, Section 512(c)(2) or for any other claim of copyright infringement, you hereby agree that notifications of claimed copyright infringement be sent by certified mail to: [insert address]
                </p>
                <p>
                  If you believe that your intellectual property right (or such a right that you are responsible for enforcing) is infringed by any content on the Site, please write to Blackline Lending at the address shown above, giving a written statement that contains:
                </p>
                <p>
                ...
                <p>
                  Blackline Lending will process any notice of alleged infringement which it receives and will take appropriate action as required by the Digital Millennium Copyright Act (DMCA) 17 U.S.C. 512(c)(3) or other applicable copyright law. U.S. law provides significant penalties for submitting such a statement falsely. Under appropriate circumstances, persons who repeatedly submit infringing or unlawful material will be prohibited from posting further submissions.
                </p>

                <p>
                  12. <b>Liability for Content.</b> You hereby acknowledge and agree that Blackline Lending  (i) stores Content and other information at the direction, request and with the authorization of its users, (ii) acts merely as a passive conduit and/or host for the uploading, storage and distribution of such Content, and (iii) plays no active role and gives no assistance in the presentation or use of the Content. You are solely responsible for all of Your Content that you upload, post or distribute to, on or through the Websites, and to the extent permissible by law, Blackline Lending excludes all liability with respect to all Content (including Your Content) and the activities of its users with respect thereto.
                </p>
                <p>
                  You hereby acknowledge and agree that Blackline Lending cannot and does not review the Content created or uploaded by its users, and neither Blackline Lending nor its subsidiaries, affiliates, successors, assigns, employees, agents, directors, officers and shareholders has any obligation, and does not undertake or assume any duty, to monitor the Websites for Content that is inappropriate, that does or might infringe any third party rights, or has otherwise been uploaded in breach of these Terms of Service or applicable law.
                </p>
                <p>
                  Blackline Lending and its subsidiaries, affiliates, successors, assigns, employees, agents, directors, officers and shareholders hereby exclude, to the fullest extent permitted by law, any and all liability which may arise from any Content uploaded to the Websites by users, including, but not limited to, any claims for infringement of intellectual property rights, rights of privacy or publicity rights, any claims relating to publication of defamatory, pornographic, obscene or offensive material, or any claims relating to the completeness, accuracy, currency or reliability of any information provided by users of the Websites. By using the Websites, you irrevocably waive the right to assert any claim with respect to any of the foregoing against Blackline Lending or any of its subsidiaries, affiliates, successors, assigns, employees, agents, directors, officers or shareholders.
                </p>

                <p>
                  13. <b>Repeat Infringers.</b> Blackline Lending will suspend or terminate your access to the Websites if Blackline Lending determines, in its sole and reasonable discretion, that you have repeatedly breached these Terms of Service.
                </p>
                <p>
                ...
                <p>
                  We will also suspend or terminate your account without warning if ordered to do so by a court, and/or in other appropriate circumstances, as determined by Blackline Lending at its sole discretion.
                </p>
                <p>
                ...
                <p>
                  14. <b>Limitation of Liability.</b> In no event shall Blackline Lending be liable for any damages whatsoever, whether direct, indirect, general, special, compensatory, consequential, and/or incidental, arising out of or relating to the Websites or Service, or use thereof. Nothing contained in this Websites or in any written or oral communications from Blackline Lending or its employees or agents shall be construed to make any promise, covenant, or guaranty, all of which are explicitly disclaimed hereby, contrary to the statements and disclaimers contained in this paragraph.
                </p>
                <p>
                  The content and functionality on the Websites and the services provided by employees of the Websites are offered "as is" without warranty of any kind, either express or implied, including, without limitation, implied warranties of merchantability, fitness for a particular purpose, title and non-infringement. Blackline Lending makes no warranties, express or implied, as to the ownership, accuracy, completeness or adequacy of the Websites’ content or that the functionality of the Websites will be uninterrupted or error-free or free from virus or third party attack. You hereby acknowledge that your use of the Websites and the Service is at your sole risk. UNDER NO CIRCUMSTANCES SHALL Blackline Lending, ITS OFFICERS, OWNERS, EMPLOYEES OR AGENTS AND THEIR RESPECTIVE HEIRS, SUCCESSORS AND ASSIGNS BE LIABLE FOR ANY DAMAGES, INCLUDING DIRECT, INCIDENTAL, PUNITIVE, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES THAT DIRECTLY OR INDIRECTLY RESULT FROM USE OF, OR INABILITY TO USE, THE WEBSITES OR SERVICE OR THE INFORMATION CONTAINED THEREIN, INCLUDING WITHOUT LIMITATION FOR VIRUSES ALLEGED TO HAVE BEEN OBTAINED FROM THE WEBSITES, EVEN IF Blackline Lending HAS BEEN NOTIFIED OF THE POSSIBILITY OF SUCH DAMAGES OR LOSSES AND REGARDLESS OF THE THEORY OF LIABILITY.
                </p>
                <p>
                  TO THE GREATEST EXTENT PERMITTED BY LAW, YOU AGREE THAT IN NO EVENT WILL Blackline Lending HAVE ANY LIABILITY, CONTINGENT OR OTHERWISE, FOR ANY INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL, OR EXEMPLARY DAMAGES IN ANY WAY ARISING OUT OF OR RELATING TO THE AGREEMENT, WEBSITES OR THE SERVICE, INCLUDING, BUT NOT LIMITED TO LOST PROFITS; LOST DATA; LOSS OF GOODWILL; COPYRIGHT, TRADEMARK, OR OTHER INTELLECTUAL PROPERTY INFRINGEMENT; WORK STOPPAGE; EQUIPMENT FAILURE OR MALFUNCTION; ILLEGAL, IMMORAL OR FRAUDULENT ACTIVITY; PERSONAL INJURY; PROPERTY DAMAGE; OR ANY OTHER DAMAGES OR LOSSES, EVEN IF Blackline Lending HAS BEEN ADVISED OF THE POSSIBILITY THEREOF, AND REGARDLESS OF THE LEGAL OR EQUITABLE THEORY (CONTRACT, TORT, STATUTE, INDEMNITY OR OTHERWISE) UPON WHICH SUCH LIABILITY IS BASED.
                </p>
                <p>
                  In the event that any of the foregoing limitations are deemed to be unenforceable, to the greatest extent permitted by law, you agree that the entire aggregate liability of Blackline Lending and sole remedy available to any Member in any case in any way arising out of or relating to the Agreement, Websites or the Service shall be limited to monetary damages that in the aggregate may not exceed the greater of $500.00 or the sum of any amount paid by the Member or user to Blackline Lending during the six months prior to notice to Blackline Lending of the dispute for which the remedy is sought.
                </p>

                <p>
                  15. <b>Indemnity by You.</b> You agree to indemnify and hold Blackline Lending, its subsidiaries, affiliates, officers, agents, and other partners and employees, harmless from any loss, liability, claim, or demand, including reasonable attorneys' fees, arising out of or related to:
                </p>
                <p>
                ...
                <p>
                  c. any activity related to your account, either by you or by any other person accessing your account with or without your consent unless such activity was caused by the act of Blackline Lending.
                </p>

                <p>
                  16. <b>Attorney Fees.</b> In the event that Blackline Lending is successful in whole or in part in any action or proceeding related to or arising from this Agreement, you shall be responsible for Blackline Lending’s attorneys' fees and costs.
                </p>

                <p>
                  17. <b>Parental or Guardian Permission.</b> Some of the Content on the Websites may not be appropriate for children. CHILDREN UNDER THE AGE OF 17 ARE NOT PERMITTED TO USE THE WEBSITES UNLESS A SUPERVISING PARENT OR GUARDIAN IS PRESENT.
                </p>
